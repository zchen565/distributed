...
func TestBasicFail(t *testing.T) {
	...
	check(ck, "1", "v1a") // this is where the problem is
	check(ck, "3", "33")
	check(ck, "4", "44")
...
func TestFailPut(t *testing.T) {
	...
	// fmt.Println(s1.db)
	// fmt.Println(s1.userstamp)
	// fmt.Println(s2.db)
	// fmt.Println(s2.userstamp)
	// fmt.Println(s3.db)
	// fmt.Println(s3.userstamp)
...
func TestConcurrentSameUnreliable(t *testing.T) {
	...
	fmt.Println("ConcurrentUnreliable TESTING")
	fmt.Printf("  ... Passed\n")
...
func TestRepeatedCrashUnreliable(t *testing.T) {
	...
	fmt.Println(sa[0].db)
	fmt.Println(sa[0].userstamp)
	fmt.Println(sa[1].db)
	fmt.Println(sa[1].userstamp)
	fmt.Println(sa[2].db)
	fmt.Println(sa[2].userstamp)
