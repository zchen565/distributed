...
type MapReduce struct {
	...
	registerChannel chan string // this is the address of worker
	...
	WorkerChannel chan *WorkerInfo //cur free worker
	JobChannel    chan *DoJobArgs  //cur job to assign
}
...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.WorkerChannel = make(chan *WorkerInfo) //set of available workers
...
func (mr *MapReduce) Run() {
	...
	mr.DoneChannel <- true //use of channel end
}
